...
public class IncomeBook {
    ...
    public IncomeBook(String licensePlate, String cost, String vehicleKind, String currentTime, ArrayList<String> services){
        ...
        this.licensePlateLabel.setText(licensePlate);
