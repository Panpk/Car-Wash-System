...
public class Server extends Application {
    ...
    public void start(Stage stage) {
        ...
        receiptButton.setOnAction(event -> {
            ...
            if (selectedVehicle != null) {
                ...
                String licensePlate = lineArray[0];
                ...
                InfoPopup popup = new InfoPopup(vehicleInfo, licensePlate, vehicleKind, services, cost, time);
        ...
        buttonsHBox.widthProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                ...
                double buttonWidth = (buttonsHBoxWidth * buttonWidthPercentage) / 100.0;

                removeButton.setPrefWidth(buttonWidth);
                receiptButton.setPrefWidth(buttonWidth);
            }
        });
                ...
                try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        if (lastThreeChars.contains("NO")) {
                            ...
                            data = tableView.addVehicleInfo(licensePlate, cost, currentTime);
                        }
                    }
                } catch (IOException e) {
                    e.printStackTrace();
    ...
    private static void handleClient(Socket clientSocket, TableViewCreation tableView) {
        try (DataInputStream inObject = new DataInputStream(clientSocket.getInputStream())) {
            ...
            vehicleInfo = new IncomeBook(licensePlate, cost, vehicleKind, currentTime, services);
        
            data = tableView.addVehicleInfo(licensePlate, cost, currentTime);  // adds the vehicle plate, cost and time in the tableview

            String combinedString = String.join("; ", licensePlate, vehicleKind, cost, String.join(", ", services), currentTime, "NO");
