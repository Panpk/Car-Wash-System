...
public class InfoPopup extends Dialog<Void>{
    ...
    public InfoPopup(IncomeBook vehicleInfo, String licensePlate, String vehicleKind, String services, String cost, String time) {
        ...
        String message = "license Plate: " + licensePlate + "\n" + servicesAsAString + "Total Cost: " + cost + "€";
